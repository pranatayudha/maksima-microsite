...
class InputValidators {
  ...
  static String? validateDependentsOrJobDuration(String? value,
    ...
    return value!.isEmpty
        ...
        : maxValue != null
            ...
            : _removeThousandsSeparator(value) < Common.minLoanLimit ||
                ...
                ? 'Plafond min ${Common.minLoanLimit ~/ 1000} rb. dan max ${Common.maxLoanLimit ~/ 1000000} jt.'
                : null;
  }
  ...
  static String? ritelValidateBirthDate(String? value,
      {required String fieldType}) {
    const Pattern pattern =
        r'^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$';
    final RegExp regex = RegExp(pattern as String);
        ...
        : maxValue != null
            ? _removeThousandsSeparator(value) > maxValue
                ...
                : _removeThousandsSeparator(value) < Common.ritelMinLoanLimit ||
                    ...
                    ? 'Plafond min ${Common.ritelMinLoanLimit ~/ 1000000}jt dan max ${Common.ritelMaxLoanLimit ~/ 1000000000}M.'
                    : null
            : null;
  }

  static String? ritelValidateRekomendasiPlafond(
      String? value, String? maksimalKredit, int? maxValue) {
    final formatter = NumberFormat('#,###', 'id_ID');
